// frontend/screens/WinterScreen.js
...
const WinterScreen = ({ navigation }) => {
  const subcategories = [
    { 
      ...
      route: 'WinterPret',
      image: require('../../assets/images/subcategories/winter-pret.jpg')
    },
    { 
      name: 'Unstitched', 
      route: 'WinterUnstitched',
  ...
  const featuredProducts = [
    {
      ...
      name: 'Winter Scarf',
      price: 950,
      image: require('../../assets/images/subcategories/winter-scarf.jpg')
    },
    {
      id: 2,
      name: 'Woolen Coat',
      price: 2700,
      image: require('../../assets/images/subcategories/winter-coat.jpg')
    }
  ];
  ...
  return (
    <View style={GlobalStyles.container}>
      <Header navigation={navigation} title="Winter Collection" />
      ...
      <ScrollView style={GlobalStyles.productContainer}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.screenTitle}>Winter Collection</Text>
